...
enum SimOne_Streaming_Image_Format
{
...
struct SimOne_Streaming_Image : public SimOne_Streaming_Data
{
	...
	SimOne_Streaming_Image_Format format; // Image format, RGB only for now
...
extern "C"
{
	...
	namespace SimOneAPI {
		...
		*	Success or not
		*/
		SIMONE_NET_API bool SetStreamingImageCB(const  char* ip, unsigned short port, void(*cb)(SimOne_Streaming_Image *pImage));
