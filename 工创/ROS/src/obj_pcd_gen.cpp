...
: nh_(), pnh_("~"), tf_listener_(tf_buffer_)
{
  ...
  dynamic_object_pub_ = pnh_.advertise<autoware_perception_msgs::DynamicObjectWithFeatureArray>("/perception/object_recognition/detection/objects", 1, true);   // /perception/object_recognition/detection/labeled_clusters    output/dynamic_object
